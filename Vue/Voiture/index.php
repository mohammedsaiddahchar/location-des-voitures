<?php $this->titre = "CarLocation - " . $this->nettoyer($voiture['id']); ?>


<article>
    <header>
        <h1 class="titre"><?= $this->nettoyer($voiture['marque']) ?></h1>
    </header>
    <p><?= $this->nettoyer($voiture['contenu']) ?></p>
</article>
<hr />
<article>
        <header>
        ...
        <p>
            <table>
        <tr><img src="<?= $this->nettoyer($voiture['image'])  ?>"></tr>
